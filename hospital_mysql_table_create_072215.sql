...
service_type ENUM('outpatient','inpatient','independent') NULL DEFAULT 'independent',
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS treatment_orders ;
...
timestamp TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
PRIMARY KEY (order_id, treatment_admin_id),
FOREIGN KEY (order_id)
REFERENCES treatment_orders (order_id),
FOREIGN KEY (treatment_admin_id)
REFERENCES treatment_administrator (treatment_admin_id));
